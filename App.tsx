...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-background-dark min-h-[100dvh]">
      <div className={`w-full mx-auto min-h-[100dvh] relative shadow-2xl flex flex-col pb-[max(20px,env(safe-area-inset-bottom))] ${!['login', 'register', 'splash', 'reset_password'].includes(currentScreen) ? 'pt-[calc(env(safe-area-inset-top)+40px)]' : 'pt-[env(safe-area-inset-top)]'}`}>
        <NotificationToast />
        <PersistentGameLoop />
