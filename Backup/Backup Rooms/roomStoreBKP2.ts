...
type RoomStore = {
    ...
    // ui/locks
    inFlight: Record<string, boolean>; // participantId -> true while mutating
...
export const useRoomStore = create<RoomStore>((set, get) => ({
    ...
    approve: async (participantId) => {
        // prevent double-click / duplicate mutations
        ...
        // always clear lock
        const { [participantId]: _removed, ...rest } = get().inFlight;
        set({ inFlight: rest });
